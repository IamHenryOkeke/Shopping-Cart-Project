    ...
    <motion.div initial = {{x : 1000}} animate = {{x : 0}} className='flex flex-col items-center mx-3'>
      ...
      <div className='flex gap-5 mb-5'>
        ...
        <a href="tel:+2347080194374">
          <svg height="25px" width="25px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>phone</title><path d="M6.62,10.79C8.06,13.62 10.38,15.94 13.21,17.38L15.41,15.18C15.69,14.9 16.08,14.82 16.43,14.93C17.55,15.3 18.75,15.5 20,15.5A1,1 0 0,1 21,16.5V20A1,1 0 0,1 20,21A17,17 0 0,1 3,4A1,1 0 0,1 4,3H7.5A1,1 0 0,1 8.5,4C8.5,5.25 8.7,6.45 9.07,7.57C9.18,7.92 9.1,8.31 8.82,8.59L6.62,10.79Z" /></svg>
        </a>
      </div>
      <div height="25px" width="25px" className='flex flex-col items-center gap-4 md:w-[60%]'>
