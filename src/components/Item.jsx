...
const Item = ({ image, title, price, category }) => {
    return (
        <div className='py-4 transition-all ease-in-out delay-150 duration-300 border-gray-200 border-2 rounded-md hover:bg-slate-100 hover:scale-105'>
          ...
          <div className='text-center w-full px-4'>
            <button className='w-full transition-all ease-in-out delay-150 duration-300 bg-[#546b56] hover:bg-black px-8 rounded-md py-2 text-white font-bold'>Add to cart</button>
          </div>
        </div>
      )
}
